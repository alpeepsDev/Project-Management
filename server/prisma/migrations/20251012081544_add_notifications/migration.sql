-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_UPDATED', 'TASK_COMPLETED', 'TASK_CHANGES_REQUESTED', 'TASK_APPROVED', 'TASK_EXCHANGE_REQUESTED', 'TASK_EXCHANGE_ACCEPTED', 'TASK_EXCHANGE_REJECTED', 'PROJECT_ASSIGNED');
